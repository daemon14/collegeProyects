<?php
	...
	$query = "SELECT libro.ID_Libro, libro.Titulo, beneficiario.ID_Benef, beneficiario.Nombre_Benef, beneficiario.Apellido_Benef, prestamo.Observacion, prestamo.Fecha_Prest
	FROM libro, prestamo, beneficiario
	WHERE libro.ID_Libro = prestamo.ID_Libro
	AND beneficiario.ID_Benef = prestamo.ID_Benef
	ORDER BY prestamo.ID_Prestamo, prestamo.Observacion, prestamo.Fecha_Prest DESC";
    ...
    <main>
      <table>
        <thead>
          <tr>
            <th style="text-align: left; width: 150px;" class="service"><b>ISBN</b></th>
            <th style="text-align: left; width: 180px;" class="desc"><b>Título del Libro<br></b></th>
            <th style="text-align: left; "><b>C.I.<br></b></th>
			<th style="text-align: left; width: 80px;"><b>Beneficiario<br></b></th>
			<th style="text-align: left; width: 150px;"><b>Observación<br></b></th>
		...
		for($i = 0; $i < count($prestamo) - 1; $i++) {
			...
			$html .= '<tr bgcolor="#F5F5F5">
						...
						<td style="text-align: left;">'.$prestamos['Observacion'].'<br></td>
	...
	$html .= '
          <tr>
            <td colspan="5" class="grand total">CANTIDAD DE PRÉSTAMOS REALIZADOS:</td>
