...
<body>
	...
	<form ACTION= 'RepTopPrestamos2.php' METHOD='post'>
	<table align='center' border = '2'>
	
	<tr> <td colspan= '2' align='center'>Seleccionar fechas</td></tr>
	...
	<tr><td colspan='2' align='center'>	<input type='submit' value='Generar reporte'></td></tr>
	</table></form>;
</body>
