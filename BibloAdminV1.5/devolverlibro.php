...
<head>
  ...
  <title>Devolver Libro - BibloAdmin</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" style="height: 100%;">
  ...
  <div style="margin-left: 18%; margin-right: 1%;  width: auto; height: 95%; background-color: white; background-position: center bottom; background-repeat: no-repeat;*/ height: auto;" class="content-wrapper">
    <div style="margin-left: 10%; height: 100%; margin-top: -8%;" class="container-fluid">
      <div style="text-align: center; height: 18%">
        <div style="text-align: left; margin-left: -10%;">
          ...
          <hr style="width: 100%;height: 100px; background: #2e2e2e; color: black; margin-left: -1.5%; col-md-3 col-sm-12">
          ...
          <center>
              ...
              <div class="form-control" style="width:70%;">
                <div class="medium-12 large-12 columns">
                  ...
                  <form method="POST" id="frmForm">
                    ...
                    <div class="medium-12  columns">
                      <input class="btn btn-warning" value="Ver Libros" id="btnSend" type="submit">
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div style="width:100%;">
                <div style="width:100%;" id="divResponse"></div>
              </div>
             </div>
        ...
        <!-- Javascript-->
        <script src="formularios/devolverlibro/assets/js/vendor/jquery.js"></script>
        <script src="formularios/devolverlibro/assets/js/vendor/what-input.js"></script>
        <script src="formularios/devolverlibro/assets/js/vendor/foundation.js"></script>
        <script src="formularios/devolverlibro/assets/js/app.js"></script>
        <script>
        function init()
        {
            $('#btnSend').click( function( event )
            {
              ...
              $.ajax({
                url: "formularios/devolverlibro/jquery/FormularioDevPrestamo.php",
                method: 'POST',
