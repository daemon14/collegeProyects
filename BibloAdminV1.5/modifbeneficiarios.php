...
<head>
  ...
  <title>Modificar Beneficiarios - BibloAdmin</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" style="height: 100%;">
  ...
  <div style="margin-left: 18%;  margin-right: 1%; width: auto; height: auto; background-color: white; background-position: center bottom; background-repeat: no-repeat;*/ height: auto; background-image: url('img/bg-benf.png');" class="content-wrapper">
    <div style="margin-left: 10%; height: 100%; margin-top: -8%; " class="container-fluid">
      <div style="text-align: center; height: 18%">
        <div style="text-align: left; margin-left: -3%;">
          ...
          <h1>Modificar Datos de los Beneficiarios</h1>
...
<div class="medium-12 large-12 columns">
  <h4>Modificación de beneficiarios</h4>
  ...
  <div style="text-align: center;">
    <b>
      <br>
    </b>Seleccione al Beneficiario el cual desea modificar.
    <br>
    <br>
  <form method="POST" id="frmForm">
    <div class="medium-12  columns">
      <label>Beneficiario a editar</label>
...
<div id="divResponse"></div>
        ...
        function init()
        {
            $('#btnSend').click( function( event )
            {
              ...
              $.ajax({
                url: "formularios/modifbeneficiarios/jquery/FormularioModifBenef.php",
                method: 'POST',
