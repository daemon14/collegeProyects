...
<head>
  ...
  <title>Búsqueda de Libros - BibloAdmin</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" style="height: 100%;">
  ...
  <div style="margin-left: 18%;  margin-right: 1%; width: auto; height: auto; background-color: white; background-position: center bottom; background-repeat: no-repeat;*/ height: auto;" class="content-wrapper">
          ...
          <hr style="width: 100%;height: 100px; background: #2e2e2e; color: black; margin-left: -8.5%; col-md-3 col-sm-12">
            ...
            <b>
              ...
              <?php	$con= mysql_connect('localhost','root','');
                ...
                <div class="row">
      <div class="form form-group medium-12 large-12 columns">
        <p><h4 class="fa fa-search fa-3x">Búsqueda</h4>	<br>Ingrese el Título o Autor del Libro que desea verificar.</p>
    <form action="formularios/search2/jquery/search.php" method="GET" id="search" class="form form-control">
        <input type="text" name="query" />
        <input class="btn btn-primary" type="submit" value="Buscar" id="btnSend"/>
    </form>
      </div>
    </div>
	<div class="form form-control form-group table-responsive" style="width:80%; height:320%">
        ...
        <!-- Javascript-->
        <!-- Jquery-->
        <script src="formularios/search2/assets/js/vendor/jquery.js"></script>
        <script src="formularios/search2/assets/js/vendor/what-input.js"></script>
        <script src="formularios/search2/assets/js/vendor/foundation.js"></script>
        <script src="formularios/search2/assets/js/app.js"></script>
        <script>
        function init()
        {
            $('#btnSend').click( function( event )
            {
              ...
              var data_to_be_sent = $('#search').serialize();

              $.ajax({
                url: "formularios/search2/jquery/search.php",
                method: 'GET',
