...
<head>
  ...
  <title>Lista de Libros Disponibles - BibloAdmin</title>
      ...
      <div style="text-align: center; height: 18%">
        <div style="text-align: left; margin-left: -3%;">
          ...
          <div style="text-align: center;">
            <b>
              <br>
            </b>Listado completo de Libros Disponibles en la Biblioteca del Liceo Bolivariano "Pedro María Freites".
            <br>
            <br>
            <br>
            <b>
                ...
                <form ACTION='formularios/insertlibro/insertlibro.php' METHOD='post'>
                  <table align='center' border='2'>
                    ...
                    <tr>
                      ...
                      <td>
                        <input size="36" type='text' name='ID_Libro' />
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input size="36" type='text' name='Titulo' />
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input size="36" type='text' name='Ejemplares' />
                      </td>
                    </tr>
