...
<head>
  ...
  <title>Lista de Préstamos - BibloAdmin</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" style="height: 100%;">
  ...
  <div style="margin-left: 18%; margin-right: 1%;  width: auto; height: 100%; background-color: white; background-position: center bottom; background-repeat: no-repeat;*/ height: auto; background-image: url('img/bg-p.png');" class="content-wrapper">
    <div style="margin-left: 10%; height: 100%; margin-top: -8%;" class="container-fluid">
          ...
          <center>
              ...
              <div class="form-control" style="width:70%;">
                <div class="medium-12 large-12 columns">
                  <h4><b>Préstamos en curso</b></h4>
                  <form method="POST" id="frmForm">
                    <div class="medium-12  columns">
                      <label><b>Seleccionar beneficiario</b></label>
                    ...
                    <div class="medium-12  columns">
                      <input class="btn btn-primary" value="Mostrar" id="btnSend" type="submit">
                    </div>
                  </form>
                </div>
              </div>
			  <div class="form form-control form-group table-responsive" style="width:80%; height:320%">
              <div class="table table-striped table-bordered table-hover" style="width:100%; position:middle">
      ...
      <!-- Javascript-->
            <script src="formularios/modifprestamos/assets/js/vendor/jquery.js"></script>
             <script src="formularios/modifprestamos/assets/js/vendor/what-input.js"></script>
             <script src="formularios/modifprestamos/assets/js/vendor/foundation.js"></script>
             <script src="formularios/modifprestamos/assets/js/app.js"></script>
             <script>
             function init()
             {
                 $('#btnSend').click( function( event )
                 {
                   ...
                   $.ajax({
                     url: "formularios/modifprestamos/jquery/FormularioDevPrestamo.php",
                     method: 'POST',
