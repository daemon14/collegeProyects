...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2018 a las 23:24:31
...
INSERT INTO `beneficiario` (`ID_Benef`, `Apellido_Benef`, `Nombre_Benef`, `Sexo`, `Tipo`) VALUES
(31245194, 'Pérez', 'Juan', 'M', 'Estudiante');
...
INSERT INTO `libro` (`ID_Libro`, `Titulo`, `ID_Area`, `ID_SubArea`, `Ejemplares`) VALUES
('978-980-218-327-2', 'Palabra Liberadora Lengua y Literatura', 400, 400, 1),
('978-980-218-339-5', 'Historia de Venezuela Contemporánea', 900, 900, 1);
...
INSERT INTO `prestamo` (`ID_Prestamo`, `ID_Benef`, `Grado`, `Seccion`, `ID_Libro`, `Fecha_Prest`, `Fecha_Dev`, `Estado`, `Observacion`) VALUES
(15, 31245194, '1', 'A', '978-980-218-339-5', '2018-03-14', '2018-04-04', 'Ocupado', 'Libro entregado en Perfecto Estado'),
(16, 31245194, '1', 'A', '978-980-218-327-2', '2018-03-14', '2018-04-01', 'Ocupado', 'Pequeña ralladura en el Libro.');
...
--
ALTER TABLE `autor`
  MODIFY `ID_Autor` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
