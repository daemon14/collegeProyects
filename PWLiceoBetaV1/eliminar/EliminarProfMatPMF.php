...
<head>
    ...
    <title>Desvinculación de profesor y materia</title>
    <script>
        $(function () {
            $("#Elim-ProfMat").dialog({
                resizable: false,
            ...
            $('#ElimProfMatBoton').on('click', function (e) {
                $("#Elim-ProfMat").dialog('open');
            });
        });
    </script>
</head>
...
<body>
    <div id="Elim-ProfMat" title="Desvincular Materia">
        <p>¿Seguro que desea desvincular la materia del profesor?</p>
    </div>
    <form id='ElimProfMatID' ACTION='eliminar/EliminarInfoProfMatPMF.php' METHOD='post'>
        <?php	
            ...
            <table align='center' border='2'>
                <tr>
                    <td colspan='2' align='center'>Desvinculación de profesor y materia</td>
                </tr>
                <tr>
		...
		WHILE ($row=mysql_fetch_array($result)){ ?>
                ...
                <tr>
                    <td colspan='2' align='center'>
                        <input type='hidden' name='ElimProfMatBoton' value='Desvincular Materia' />
                        <input type='button' id='ElimProfMatBoton' name='ElimProfMatBoton' value='Desvincular Materia'>
                    </td>
                </tr>
            </table>
    </form>
