...
?>
                            ...
                            <div>
                                ...
                                <p>
                                    <?php
include ('formularios/FormularioUserPMF.php');
?>
                                </p>
                                &nbsp; &nbsp; &nbsp;
                                <p>
                                    <?php
include ('eliminar/EliminarUserPMF.php');
?>
                                </p>
                                &nbsp; &nbsp; &nbsp;
                                <p>
                                    <?php
include ('actualizar/ActualizarUserPMF.php');
?>
                                </p>
                            </div>
                            <h3>Reportes</h3>
	...
	echo 	"<p><h3>Generar reporte de todos los profesores.<a href='Rep_ProfTodos.php'><img
			...
			<p><h3>Generar reporte de materias que se imparten.<a href='Rep_Materias.php'><img
				src='image/link.png' alt='link' align='absmiddle' style='width: 27px; height: 27px;' /></a></h3></p>
		    <p><h3>Imprimir tabla años.<a href='TablaAnios.php'><img
				src='image/link.png' alt='link' align='absmiddle' style='width: 27px; height: 27px;' /></a></h3></p>
			<p><h3>Imprimir tabla materia.<a href='TablaMateria.php'><img
				src='image/link.png' alt='link' align='absmiddle' style='width: 27px; height: 27px;' /></a></h3></p>
			<p><h3>Imprimir tabla profesor.<a href='TablaProf.php'><img
				src='image/link.png' alt='link' align='absmiddle' style='width: 27px; height: 27px;' /></a></h3></p>                
        	<p><h3>Imprimir tabla seccion.<a href='TablaSeccion.php'><img
				src='image/link.png' alt='link' align='absmiddle' style='width: 27px; height: 27px;' /></a></h3></p>";
}
?>
                                </p>
