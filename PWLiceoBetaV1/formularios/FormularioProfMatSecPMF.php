...
<head>
    ...
    <title>Vinculación de profesor, materia y sección</title>
    <script>
        $(function () {
            $("#Vinc-ProfMatSec").dialog({
                resizable: false,
                height: 190,
                autoOpen: false,
                width: 330,
            ...
            $('#ProfMatSecBoton').on('click', function (e) {
                $("#Vinc-ProfMatSec").dialog('open');
            });
        });
    </script>
</head>
...
<body>
    <div id="Vinc-ProfMatSec" title="Asignar Sección">
        <p>¿Seguro que desea vincular al profesor con la sección?</p>
    </div>
    <form id='ProfMatSecID' ACTION='InsertarInfoProfMatSecPMF.php' METHOD='post'>
        <?php	
            ...
            <table align='center' border='2'>
                <tr>
                    <td colspan='2' align='center'>Vinculación de profesor, materia y sección</td>
                </tr>
                <tr>
		...
		WHILE ($row=mysql_fetch_array($result)){ ?>
                ...
                <tr>
                    <td colspan='2' align='center'>
                        <input type='hidden' name='ProfMatSecBoton' value='Asignar Sección' />
                        <input type='button' id='ProfMatSecBoton' name='ProfMatSecBoton' value='Asignar Sección'>
                    </td>
                </tr>
            </table>
    </form>
