...
*active
 <div style="width: 100%; margin-bottom:30px;">     
     <div>
        ...
        <div style="text-align:right;">[print][/print]</div>      
     </div>
     ...
     <div style="float: right;">[com-link]Comentarios: {comments-num} [/com-link]</div>
     <div>{avatar}<em>Publicado el {date} por {author}</em></div>
     <div>{fb-comments}</div>
     <div>
...
*full
 <div style="width: 100%; margin-bottom:15px;">
     ...
     <div style="float: right;">Comentarios: {comments-num}</div>
...
#headlines
*active
 [full-link]{title}[/full-link], publicado por {date} por {author}<br />
