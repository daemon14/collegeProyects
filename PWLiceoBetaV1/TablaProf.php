      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="text-align: center; width: 399px;" class="desc"><b>NOMBRE<br>
              </b></th>
            <th style="width: 213px;"><b>CI<br>
              </b></th>
          </tr>
        </thead>
        <tbody>';
...
//		foreach ($profesor as $profe) {
	...
	$html .= '
          <tr>
            <td colspan="3" class="grand total" align="center">NUMERO DE REGISTROS:'." ".($row_cnt).'</td>
            </td>
          </tr>
        </tbody>
      </table>
